...
class MainWindow(tk.Tk):
    ...
    def on_click2(self):
        ...
        # Create sliders for saturation, white balance, and brightness
        cv2.createTrackbar("Saturation", "Prerecorded Video Test", 100, 200, lambda pos: None)
        cv2.createTrackbar("Whites", "Prerecorded Video Test", 100, 200, lambda pos: None)
        cv2.createTrackbar("Brightness", "Prerecorded Video Test", 100, 200, lambda pos: None)
        ...
        while True:
            if is_playing:
                ...
                if success:
                    ...
                    # Get slider values for saturation, white balance, and brightness
                    ...
                    brightness = cv2.getTrackbarPos("Brightness", "Prerecorded Video Test") / 100.0

                    # Adjust saturation, white balance, and brightness
                    img = cv2.convertScaleAbs(img, alpha=saturation, beta=brightness * whites)
