...
class MainWindow(tk.Tk):
    ...
    def on_click2(self):
        ...
        # Create a trackbar for brightness
        cv2.createTrackbar("Brightness", "Prerecorded Video Test", 10, 50, lambda pos: None)
        ...
        while True:
            if is_playing:
                ...
                if success:
                    ...
                    brightness_value = cv2.getTrackbarPos("Brightness", "Prerecorded Video Test")

                    # Enhance colors with adjustable brightness
                    img = cv2.convertScaleAbs(img, alpha=1.2, beta=brightness_value)
